  ...
  return (
    <nav className={classes.navbar}>
      <ul className={classes.list}>
        <li
          className={
            pathname.includes(routesPrefixes.account)
              ? classes.selected
              : ""
          }
        >
        ...
        <li
          className={
            pathname.startsWith(routesPrefixes.movement) ? classes.selected : ""
          }
        >
          <Link to={appRoutes.intermediaryMovementAccount}>Movimientos</Link>
        </li>
        <li
          className={
